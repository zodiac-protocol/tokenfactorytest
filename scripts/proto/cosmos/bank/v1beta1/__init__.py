...
class GenesisState(betterproto.Message):
    ...
    supply_offsets: List["GenesisSupplyOffset"] = betterproto.message_field(5)
...
@dataclass(eq=False, repr=False)
class GenesisSupplyOffset(betterproto.Message):
    """
    GenesisSupplyOffset encodes the supply offsets, just for genesis. The
    offsets are serialized directly by denom in state.
    """

    # Denom
    denom: str = betterproto.string_field(1)
    # SupplyOffset
    offset: str = betterproto.string_field(2)
...
@dataclass(eq=False, repr=False)
class QueryTotalSupplyWithoutOffsetRequest(betterproto.Message):
    """
    QueryTotalSupplyWithoutOffsetRequest is the request type for the
    Query/TotalSupplyWithoutOffset RPC method.
    """
...
@dataclass(eq=False, repr=False)
class QueryTotalSupplyWithoutOffsetResponse(betterproto.Message):
    """
    QueryTotalSupplyWithoutOffsetResponse is the response type for the
    Query/TotalSupplyWithoutOffset RPC method
    """
...
@dataclass(eq=False, repr=False)
class QuerySupplyOfWithoutOffsetRequest(betterproto.Message):
    """
    QuerySupplyOfWithoutOffsetRequest is the request type for the
...
@dataclass(eq=False, repr=False)
class QuerySupplyOfWithoutOffsetResponse(betterproto.Message):
    """
    QuerySupplyOfWithoutOffsetResponse is the response type for the
    Query/SupplyOfWithoutOffset RPC method.
    """
...
class QueryBaseDenomRequest(betterproto.Message):
    """
    QueryBaseDenomRequest defines the request type for the BaseDenom gRPC
    method.
    """
...
class QueryBaseDenomResponse(betterproto.Message):
    """
    QueryBaseDenomResponse defines the response type for the BaseDenom gRPC
    method.
    """
...
class QueryStub(betterproto.ServiceStub):
    ...
    async def total_supply_without_offset(
        self, *, pagination: "__base_query_v1_beta1__.PageRequest" = None
    ...
    async def supply_of_without_offset(
        self, *, denom: str = ""
    ...
    async def base_denom(self, *, denom: str = "") -> "QueryBaseDenomResponse":
        request = QueryBaseDenomRequest()
        request.denom = denom

        return await self._unary_unary(
            "/cosmos.bank.v1beta1.Query/BaseDenom", request, QueryBaseDenomResponse
        )
...
class QueryBase(ServiceBase):
    ...
    async def __rpc_total_supply_without_offset(
        ...
        response = await self.total_supply_without_offset(**request_kwargs)
        await stream.send_message(response)

    async def __rpc_supply_of_without_offset(
        self, stream: grpclib.server.Stream
    ) -> None:
        request = await stream.recv_message()
        ...
        response = await self.supply_of_without_offset(**request_kwargs)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/cosmos.bank.v1beta1.Query/TotalSupplyWithoutOffset": grpclib.const.Handler(
                self.__rpc_total_supply_without_offset,
                grpclib.const.Cardinality.UNARY_UNARY,
                QueryTotalSupplyWithoutOffsetRequest,
                QueryTotalSupplyWithoutOffsetResponse,
            ),
            "/cosmos.bank.v1beta1.Query/SupplyOfWithoutOffset": grpclib.const.Handler(
                self.__rpc_supply_of_without_offset,
                grpclib.const.Cardinality.UNARY_UNARY,
            ...
            "/cosmos.bank.v1beta1.Query/BaseDenom": grpclib.const.Handler(
